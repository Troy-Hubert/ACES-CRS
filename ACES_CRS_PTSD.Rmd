...
The code below was primarily written by [Hannah Wild](https://www.linkedin.com/in/hannah-wild-she-her-83272131) and optimized by the primary author [Troy Hubert](https://github.com/Troy-Hubert).
...
TTab       <- xtabs(~ Trauma + Type, data = LEC_long)
TTab2 <- data.frame(TTab)
percent    <- round((100*(prop.table(TTab))),2)
TTab[,1] <- paste(TTab[,1], "(",percent[,1],"%",")")
TTab[,2] <- paste(TTab[,2], "(",percent[,2],"%",")")
TTab[,3] <- paste(TTab[,3], "(",percent[,3],"%",")")
